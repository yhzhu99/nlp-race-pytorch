...
class DataModule(L.LightningDataModule):
    def __init__(self, datadir, batch_size):
        ...
        tokenizer = AutoTokenizer.from_pretrained("Shaier/longformer_race", cache_dir="logs/cache/longformer-tokenizer")
...
class Pipeline(L.LightningModule):
    ...
    def __init__(self):
        super().__init__()
        model = AutoModelForMultipleChoice.from_pretrained("Shaier/longformer_race", cache_dir="logs/cache/longformer-model")
        self.model = model
        self.outputs = []
...
if __name__ == "__main__":
    ...
    checkpoint_filename = 'longformer-all'
    ...
    trainer.test(pipeline, dm, ckpt_path="logs/race/longformer-all/checkpoints/best.ckpt")
